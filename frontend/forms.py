...
from frontend.models import Client, Category, Package, Job
...
class CategoryForm(forms.ModelForm):
    ...
    def clean_name(self):
        ...
        if string.whitespace in name or string.ascii_uppercase in name:
            message = 'Cannot contain any whitespace or uppercase characters!'
...
class PackageForm(forms.ModelForm):
    ...
    parent_package = forms.ModelChoiceField(Package.objects.filter(is_base_package=True)
                                            .filter(category__name='tv_episodes'), required=False)
    ...
    def clean(self):
        # This is called after the individual field cleans are called
